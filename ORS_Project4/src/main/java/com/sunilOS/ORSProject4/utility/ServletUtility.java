...
import com.sunilOS.ORSProject4.controller.BaseCtl;
import com.sunilOS.ORSProject4.controller.ORSView;
...
public class ServletUtility {
   ...
   /* public static long getRole(HttpServletRequest request) {
    ...
    public static int getPageSize(HttpServletRequest request) {
        ...
        //DataUtility.getInt((String)request.getAttribute("pageSize"));//(int) request.getAttribute("pageSize");
    }
