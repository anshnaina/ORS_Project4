...
public final class JDBCDataSource {
	...
	// Make a get instance() static method in singleton class that will return instance of same single class
	...
	public static JDBCDataSource getInstance() {
		if (datasource == null) {
			...
			ResourceBundle rb = ResourceBundle.getBundle("in.co.sunilOS.ORSProject4.bundle.system");
	...
	/**
	 * a Gets the connection from ComboPooledDataSource
	 * 
	 * @return connection
	 */
