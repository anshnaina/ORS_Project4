...
public interface ORSView {
	 ...
	 public String APP_CONTEXT = "/ORS_Project4";
	  ...
	  public String LAYOUT_VIEW = "/BaseLayout.jsp";
	    ...
	    public String MARKSHEET_GET_VIEW = PAGE_FOLDER + "/MarksheetGetView.jsp";
	    ...
	    public String MARKSHEET_GET_CTL = APP_CONTEXT + "/ctl/MarksheetGetCtl";
	    public String CHANGE_PASSWORD_CTL = APP_CONTEXT + "/ctl/ChangePasswordCtl";
	    public String MY_PROFILE_CTL = APP_CONTEXT + "/ctl/MyProfileCtl";
	    public String FORGOT_PASSWORD_CTL = APP_CONTEXT + "/ForgotPasswordCtl";
